...
fwrite(frqs, file = "interpolated_frq_physical_map.txt", quote=F, sep = "/t", col.names=T, row.names = F)
fwrite(frqsM, file = "interpolated_frq_genetic_map.txt", quote=F, sep = "/t", col.names=T, row.names = F)
